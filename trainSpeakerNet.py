...
parser.add_argument('--train_list',     type=str,   default="/home/21151213641/xdhpc/train_vox2.txt", help='Train list')
parser.add_argument('--test_list',      type=str,   default="/home/21151213641/xdhpc/veri_test2.txt", help='Evaluation list')
parser.add_argument('--train_path',     type=str,   default="/home/21151213641/xdhpc/voxceleb2/",     help='Absolute path to the train set')
parser.add_argument('--test_path',      type=str,   default="/home/21151213641/xdhpc/wav/", help='Absolute path to the test set')
parser.add_argument('--musan_path',     type=str,   default="/home/21151213641/xdhpc/musan_split", help='Absolute path to the test set')
parser.add_argument('--rir_path',       type=str,   default="/home/21151213641/xdhpc/RIRS_NOISES/simulated_rirs", help='Absolute path to the test set')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    ## Load model weights
    modelfiles = glob.glob('%s/model0*.model'%args.model_save_path)  #返回所有匹配的文件路径列表
    modelfiles.sort()
    if(args.initial_model != ""):
        trainer.loadParameters(args.initial_model)
        print("Model {} loaded!".format(args.initial_model))
    elif len(modelfiles) >= 1:
        print("len(modelfiles): ", len(modelfiles))
...
def main():
    ...
    for i in range(torch.cuda.device_count()):
        print("gpu_num: {} | gpu_name: {}".format(torch.cuda.device_count(), torch.cuda.get_device_name(i)))
